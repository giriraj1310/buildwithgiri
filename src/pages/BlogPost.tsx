  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-200 font-body">
      <div className="max-w-3xl mx-auto py-20 px-6">
        ...
        <Link
          to="/#blog"
          className="inline-block text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 mb-8 transition"
        >
          ← Back to Blog
        </Link>
        ...
        {/* Title */}
        <h1 className="text-4xl font-display font-bold mb-4 leading-tight text-gray-900 dark:text-white">
          {title}
        </h1>
        ...
        {tags?.length > 0 && (
          <div className="flex flex-wrap gap-2 mb-10">
            {tags.map((tag) => (
              <span
                key={tag}
                className="bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-xs px-3 py-1 rounded-full"
              >
                #{tag}
              </span>
            ))}
