...
export default function Navbar({ isMobileMenuOpen, setMobileMenuOpen }) {
  return (
    <>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white shadow-md px-6 py-4 space-y-2">
          <Link to="about" smooth={true} duration={500} offset={-60} className="block hover:text-blue-600 cursor-pointer">
            About
          </Link>
          <Link to="career" smooth={true} duration={500} offset={-60} className="block hover:text-blue-600 cursor-pointer">
            Career
          </Link>
          {/* <Link to="students" smooth={true} duration={500} offset={-60} className="block hover:text-blue-600 cursor-pointer">
            For Students
          </Link>
          <Link to="blog" smooth={true} duration={500} offset={-60} className="block hover:text-blue-600 cursor-pointer">
            Blog
          </Link> */}
          <Link to="contact" smooth={true} duration={500} offset={-60} className="block hover:text-blue-600 cursor-pointer">
            Contact
          </Link>
        </div>
      )}
